import { FaShippingFast, FaLeaf, FaHeart, FaLinkedin } from 'react-icons/fa';
...
export const socialIcons = [
    { icon: FaLinkedin, link: 'https://www.linkedin.com/in/muhammad-ali-gadit-07932b2b9/', color: '#3b5998', label: 'Linkedin' },
    { icon: FaInstagram, link: 'https://www.instagram.com/gaditali', color: '#E1306C', label: 'Instagram' },
    { icon: FaXTwitter, link: 'https://x.com/Ali__Gadit', color: '#000', label: 'X' },
];
...
export const contactFormFields = [
    ...
    { label: 'Phone Number', name: 'phone', type: 'tel', placeholder: '+92 12345 67890', pattern: "[+]{0,1}[0-9]{10,13}", Icon: FiSmartphone },
