...
const OurMenu = () => {
    ...
    if (loading) {
        return <div className="min-h-screen flex items-center justify-center bg-[#1a120b] text-amber-100 font-cinzel text-xl">Loading Menu...</div>;
    }
                                        ...
                                        {qty > 0 ? (
                                            ...
                                            onClick={()=> {
                                                if (cartEntry && cartEntry._id) {
                                                    ...
                                                    console.error("Cart Entry missing or invalid:", cartEntry);
                                                }
                                            }}>
