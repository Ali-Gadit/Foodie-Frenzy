...
import { FiArrowDownRight, FiGlobe, FiMail, FiMapPin, FiMessageSquare, FiPhone } from "react-icons/fi";
...
const Contact = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-r from-orange-900 via-amber-900 to-green-900 animate-gradient-x py-12 sm:py-16 md:py-20 
          ...
          <div className="space-y-6">
            ...
            <div className="relative bg-white/5 backdrop-blur-lg rounded-2xl p-6 shadow-2xl transform transition-all duration-300 hover:scale-[1.02] animate-card-float border-l-4 border-amber-500 hover:border-amber-400 group">
              ...
              <div className="pl-12 relative z-10">
                <p className="text-amber-100 font-light text-lg">Karachi, Pakistan</p>
              </div>
            </div>
            ...
            <form onSubmit={handleSubmit} className="space-y-6 relative z-10">
              ...
              <button
                ...
                className="w-full bg-gradient-to-r from-amber-600 to-orange-600 hover:from-amber-700 hover:to-orange-700
                 text-white font-semibold py-3 px-6 rounded-xl transition-all duration-300 transform hover:scale-[1.02]
                 shadow-lg hover:shadow-amber-500/20 flex items-center justify-center space-x-2 group"
              >
                <span>Submit Query</span>
                <FiArrowDownRight className="w-5 h-5 group-hover:translate-x-1 transition-transform"/>
              </button>
            </form>
          </div>
        </div>
