        ...
        <div className='max-w-7xl mx-auto relative z-10'>
            <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-8 mb-12'>
                ...
                <div className='space-y-6'>
                    <h2 className='text-4xl sm:text-5xl md:text-6xl font-bold font-sacramento text-amber-400 animate-pulse'>
                        Foodie-Frenzy
                    </h2>
                    <p className='text-amber-200/90 text-xm font-sacramento italic'>
                    ...
                    <form onSubmit={handleSubmit} className='relative mt-4 group'>
                        ...
                        <div className='relative'>
                            ...
                            required/>
                            <button type='submit' className='absolute right-1 top-1 bg-gradient-to-br from-amber-300 via-orange-500 to-amber-600 text-white px-4 py-2 rounded-full
            ...
            <div className='border-t border-amber-800 pt-8 mt-8 text-center'>
                ...
                <div className='group inline-block'>
                    <a href="https://my-portfolio-two-nu-51.vercel.app/"
