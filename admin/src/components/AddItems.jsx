...
//   FOR IMAGE HANDLING 
  ...
  const handleSubmit = async e => {
    ...
    try{
        ...
        const res = await axios.post(`${backendUrl}/api/items`,payload,{
        ...
        console.error("Error uplaoding item:",err.response || err.message)
    }
  }
              ...
              <div className={styles.gridTwoCols}>
                <div>
                  ...
                  >
                    ...
                    {categories.map(c=>(
                        <option value={c} key={c} className="bg-[#3a2b2b]">{c}</option>
                    ))}
                  </select>
                </div>
              ...
              <div className={styles.gridTwoCols}>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-3 sm:gap-4">
                    <button onClick={handleHearts} type="button" className="text-2xl sm:text-3xl text-amber-400 hover:text-amber-300 transition-colors animate-pulse">
                      <FiHeart/>
                    </button>
                    <input
                      className={styles.inputField + " pl-10 sm:pl-12"}
